...
const Goods4 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div>
        <img className="image1" src="https://static.wixstatic.com/media/84770f_ad69de0ded0845ecb2be4c325fc0d7b2.png/v1/fill/w_417,h_417,al_c,q_90,usm_0.66_1.00_0.01/84770f_ad69de0ded0845ecb2be4c325fc0d7b2.webp" alt="picture"/>
        </div>
