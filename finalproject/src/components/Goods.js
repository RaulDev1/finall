...
const Goods = () => {
    ...
    return (
        <section className="hero">
         ...
         <div>
        <img className="image1" src="https://static.wixstatic.com/media/84770f_1720a41d8a7f4f51be2e910b346afb2d.jpg/v1/fill/w_417,h_417,al_c,q_85,usm_0.66_1.00_0.01/84770f_1720a41d8a7f4f51be2e910b346afb2d.webp" alt="picture"/>
        </div>
