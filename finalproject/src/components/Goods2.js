...
const Goods2 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div>
        <img className="image1" src="https://static.wixstatic.com/media/84770f_054a710970294c8a91eeea7d1b20f44d.png/v1/fill/w_417,h_417,al_c,q_90,usm_0.66_1.00_0.01/84770f_054a710970294c8a91eeea7d1b20f44d.webp" alt="picture"/>
        </div>
