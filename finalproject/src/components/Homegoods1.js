...
const Homegoods1 = () => {
    return (
        <section className="hero">
         ...
         <div>
        <img className="image1" src="https://static.wixstatic.com/media/84770f_92ad288f7eb849c68652826216de56dc.png/v1/fill/w_417,h_417,al_c,q_90,usm_0.66_1.00_0.01/84770f_92ad288f7eb849c68652826216de56dc.webp" alt="picture"/>
        </div>
        ...
        <div className="vestaft">ВЕСТА</div>
        ...
        <div className="textft">ПОМОЩЬ КЛИЕНТАМ</div>
        <div className="textft1">ЗАХОДИТЕ К НАМ</div>
        <div className="textft2">ПРИСОЕДИНЯЙТЕСЬ</div>

        <div className="textft3">Политика доставки ></div>
        <div className="textft4">Политика возврата ></div>
        <div className="textft5">Контакты ></div>
        <div className="textft6">О нас ></div>
        <div className="textft7">ул. Арбат, 1а, Москва,</div>
        <div className="textft8">119019, Россия</div>
        <div>
