...
const Goods6 = () => {
    ...
    return (
        <section className="hero">
         ...
         <div>
        <img className="image1" src="https://static.wixstatic.com/media/84770f_8bba0cf04db947de8d9542f081e545ad.png/v1/fill/w_417,h_417,al_c,q_90,usm_0.66_1.00_0.01/84770f_8bba0cf04db947de8d9542f081e545ad.webp" alt="picture"/>
        </div>
